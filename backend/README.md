...
## Project Structure
    ...
    ├── arranging_catalog_f_41978  # Django project configurations
...
1. Clone this repo and `cd arranging_catalog_f_41978`
...
2. Clone this repo and `cd arranging_catalog_f_41978`
